...
export class NotionAPI {
    ...
    if (fetchCollections) {
      ...
      await pMap(
        ...
        async (collectionInstance) => {
          ...
          try {
            console.log("collectionId", collectionId, "collectionViewId", collectionViewId, "collectionView", collectionView);
  ...
  public async getPageRaw(
    ...
    const parsedPageId = parsePageId("acd18d297b8c4eb1823d21f63088898c")
	console.log("feafe   ",parsedPageId);
    if (!parsedPageId) {
    ...
    const body = {
      pageId: parsedPageId,
    //   pageId: "acd18d297b8c4eb1823d21f63088898c",
      limit: chunkLimit,
